...
__all__ = [
    'GetIngestProcessorUrldecodeResult',
    'AwaitableGetIngestProcessorUrldecodeResult',
    'get_ingest_processor_urldecode',
    'get_ingest_processor_urldecode_output',
]

@pulumi.output_type
class GetIngestProcessorUrldecodeResult:
    """
...
class AwaitableGetIngestProcessorUrldecodeResult(GetIngestProcessorUrldecodeResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIngestProcessorUrldecodeResult(
...
def get_ingest_processor_urldecode(description: Optional[str] = None,
                                   ...
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIngestProcessorUrldecodeResult:
    """
    ...
    :param str field: The field to decode
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/getIngestProcessorUrldecode:getIngestProcessorUrldecode', __args__, opts=opts, typ=GetIngestProcessorUrldecodeResult).value

    return AwaitableGetIngestProcessorUrldecodeResult(
...
@_utilities.lift_output_func(get_ingest_processor_urldecode)
def get_ingest_processor_urldecode_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                          ...
                                          opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetIngestProcessorUrldecodeResult]:
    """
    URL-decodes a string. If the field is an array of strings, all members of the array will be decoded.
