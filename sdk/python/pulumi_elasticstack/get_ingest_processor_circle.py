...
__all__ = [
    'GetIngestProcessorCircleResult',
    'AwaitableGetIngestProcessorCircleResult',
    'get_ingest_processor_circle',
    'get_ingest_processor_circle_output',
]

@pulumi.output_type
class GetIngestProcessorCircleResult:
    """
...
class AwaitableGetIngestProcessorCircleResult(GetIngestProcessorCircleResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIngestProcessorCircleResult(
...
def get_ingest_processor_circle(description: Optional[str] = None,
                                ...
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIngestProcessorCircleResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/getIngestProcessorCircle:getIngestProcessorCircle', __args__, opts=opts, typ=GetIngestProcessorCircleResult).value

    return AwaitableGetIngestProcessorCircleResult(
...
@_utilities.lift_output_func(get_ingest_processor_circle)
def get_ingest_processor_circle_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                       ...
                                       opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetIngestProcessorCircleResult]:
    """
    Helper data source to which can be used to create a processor to convert circle definitions of shapes to regular polygons which approximate them.
