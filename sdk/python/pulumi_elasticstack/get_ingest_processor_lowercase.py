...
__all__ = [
    'GetIngestProcessorLowercaseResult',
    'AwaitableGetIngestProcessorLowercaseResult',
    'get_ingest_processor_lowercase',
    'get_ingest_processor_lowercase_output',
]

@pulumi.output_type
class GetIngestProcessorLowercaseResult:
    """
...
class AwaitableGetIngestProcessorLowercaseResult(GetIngestProcessorLowercaseResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIngestProcessorLowercaseResult(
...
def get_ingest_processor_lowercase(description: Optional[str] = None,
                                   ...
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIngestProcessorLowercaseResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/getIngestProcessorLowercase:getIngestProcessorLowercase', __args__, opts=opts, typ=GetIngestProcessorLowercaseResult).value

    return AwaitableGetIngestProcessorLowercaseResult(
...
@_utilities.lift_output_func(get_ingest_processor_lowercase)
def get_ingest_processor_lowercase_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                          ...
                                          opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetIngestProcessorLowercaseResult]:
    """
    Converts a string to its lowercase equivalent. If the field is an array of strings, all members of the array will be converted.
