...
__all__ = [
    'GetIngestProcessorSplitResult',
    'AwaitableGetIngestProcessorSplitResult',
    'get_ingest_processor_split',
    'get_ingest_processor_split_output',
]

@pulumi.output_type
class GetIngestProcessorSplitResult:
    """
...
class AwaitableGetIngestProcessorSplitResult(GetIngestProcessorSplitResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIngestProcessorSplitResult(
...
def get_ingest_processor_split(description: Optional[str] = None,
                               ...
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIngestProcessorSplitResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/getIngestProcessorSplit:getIngestProcessorSplit', __args__, opts=opts, typ=GetIngestProcessorSplitResult).value

    return AwaitableGetIngestProcessorSplitResult(
...
@_utilities.lift_output_func(get_ingest_processor_split)
def get_ingest_processor_split_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                      ...
                                      opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetIngestProcessorSplitResult]:
    """
    Splits a field into an array using a separator character. Only works on string fields.
