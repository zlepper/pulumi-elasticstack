...
__all__ = [
    'GetIngestProcessorRegisteredDomainResult',
    'AwaitableGetIngestProcessorRegisteredDomainResult',
    'get_ingest_processor_registered_domain',
    'get_ingest_processor_registered_domain_output',
]

@pulumi.output_type
class GetIngestProcessorRegisteredDomainResult:
    """
...
class AwaitableGetIngestProcessorRegisteredDomainResult(GetIngestProcessorRegisteredDomainResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIngestProcessorRegisteredDomainResult(
...
def get_ingest_processor_registered_domain(description: Optional[str] = None,
                                           ...
                                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIngestProcessorRegisteredDomainResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/getIngestProcessorRegisteredDomain:getIngestProcessorRegisteredDomain', __args__, opts=opts, typ=GetIngestProcessorRegisteredDomainResult).value

    return AwaitableGetIngestProcessorRegisteredDomainResult(
...
@_utilities.lift_output_func(get_ingest_processor_registered_domain)
def get_ingest_processor_registered_domain_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                                  ...
                                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetIngestProcessorRegisteredDomainResult]:
    """
    Extracts the registered domain (also known as the effective top-level domain or eTLD), sub-domain, and top-level domain from a fully qualified domain name (FQDN). Uses the registered domains defined in the Mozilla Public Suffix List.
