...
__all__ = [
    'GetIngestProcessorHtmlStripResult',
    'AwaitableGetIngestProcessorHtmlStripResult',
    'get_ingest_processor_html_strip',
    'get_ingest_processor_html_strip_output',
]

@pulumi.output_type
class GetIngestProcessorHtmlStripResult:
    """
...
class AwaitableGetIngestProcessorHtmlStripResult(GetIngestProcessorHtmlStripResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIngestProcessorHtmlStripResult(
...
def get_ingest_processor_html_strip(description: Optional[str] = None,
                                    ...
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIngestProcessorHtmlStripResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/getIngestProcessorHtmlStrip:getIngestProcessorHtmlStrip', __args__, opts=opts, typ=GetIngestProcessorHtmlStripResult).value

    return AwaitableGetIngestProcessorHtmlStripResult(
...
@_utilities.lift_output_func(get_ingest_processor_html_strip)
def get_ingest_processor_html_strip_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                           ...
                                           opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetIngestProcessorHtmlStripResult]:
    """
    Removes HTML tags from the field. If the field is an array of strings, HTML tags will be removed from all members of the array.
