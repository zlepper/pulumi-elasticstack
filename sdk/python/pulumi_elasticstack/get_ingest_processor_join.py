...
__all__ = [
    'GetIngestProcessorJoinResult',
    'AwaitableGetIngestProcessorJoinResult',
    'get_ingest_processor_join',
    'get_ingest_processor_join_output',
]

@pulumi.output_type
class GetIngestProcessorJoinResult:
    """
...
class AwaitableGetIngestProcessorJoinResult(GetIngestProcessorJoinResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIngestProcessorJoinResult(
...
def get_ingest_processor_join(description: Optional[str] = None,
                              ...
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIngestProcessorJoinResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/getIngestProcessorJoin:getIngestProcessorJoin', __args__, opts=opts, typ=GetIngestProcessorJoinResult).value

    return AwaitableGetIngestProcessorJoinResult(
...
@_utilities.lift_output_func(get_ingest_processor_join)
def get_ingest_processor_join_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                     ...
                                     opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetIngestProcessorJoinResult]:
    """
    Joins each element of an array into a single string using a separator character between each element. Throws an error when the field is not an array.
