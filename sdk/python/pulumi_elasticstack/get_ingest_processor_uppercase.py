...
__all__ = [
    'GetIngestProcessorUppercaseResult',
    'AwaitableGetIngestProcessorUppercaseResult',
    'get_ingest_processor_uppercase',
    'get_ingest_processor_uppercase_output',
]

@pulumi.output_type
class GetIngestProcessorUppercaseResult:
    """
...
class AwaitableGetIngestProcessorUppercaseResult(GetIngestProcessorUppercaseResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIngestProcessorUppercaseResult(
...
def get_ingest_processor_uppercase(description: Optional[str] = None,
                                   ...
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIngestProcessorUppercaseResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/getIngestProcessorUppercase:getIngestProcessorUppercase', __args__, opts=opts, typ=GetIngestProcessorUppercaseResult).value

    return AwaitableGetIngestProcessorUppercaseResult(
...
@_utilities.lift_output_func(get_ingest_processor_uppercase)
def get_ingest_processor_uppercase_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                          ...
                                          opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetIngestProcessorUppercaseResult]:
    """
    Converts a string to its uppercase equivalent. If the field is an array of strings, all members of the array will be converted.
