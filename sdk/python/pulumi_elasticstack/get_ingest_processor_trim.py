...
__all__ = [
    'GetIngestProcessorTrimResult',
    'AwaitableGetIngestProcessorTrimResult',
    'get_ingest_processor_trim',
    'get_ingest_processor_trim_output',
]

@pulumi.output_type
class GetIngestProcessorTrimResult:
    """
...
class AwaitableGetIngestProcessorTrimResult(GetIngestProcessorTrimResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIngestProcessorTrimResult(
...
def get_ingest_processor_trim(description: Optional[str] = None,
                              ...
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIngestProcessorTrimResult:
    """
    ...
    **NOTE:** This only works on leading and trailing whitespace.
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/getIngestProcessorTrim:getIngestProcessorTrim', __args__, opts=opts, typ=GetIngestProcessorTrimResult).value

    return AwaitableGetIngestProcessorTrimResult(
...
@_utilities.lift_output_func(get_ingest_processor_trim)
def get_ingest_processor_trim_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                     ...
                                     opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetIngestProcessorTrimResult]:
    """
    Trims whitespace from field. If the field is an array of strings, all members of the array will be trimmed.
