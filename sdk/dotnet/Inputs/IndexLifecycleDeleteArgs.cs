...
namespace Pulumi.Elasticstack.Inputs
{
    ...
    public sealed class IndexLifecycleDeleteArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Permanently removes the index.
        /// </summary>
        [Input("delete")]
        public Input<Inputs.IndexLifecycleDeleteDeleteArgs>? Delete { get; set; }
        ...
        public Input<Inputs.IndexLifecycleDeleteWaitForSnapshotArgs>? WaitForSnapshot { get; set; }

        public IndexLifecycleDeleteArgs()
        {
        }
        public static new IndexLifecycleDeleteArgs Empty => new IndexLifecycleDeleteArgs();
    }
}
