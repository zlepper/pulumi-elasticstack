...
namespace Pulumi.Elasticstack.Inputs
{
    ...
    public sealed class SecurityRoleIndexGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("fieldSecurity")]
        public Input<Inputs.SecurityRoleIndexFieldSecurityGetArgs>? FieldSecurity { get; set; }
        ...
        public SecurityRoleIndexGetArgs()
        {
        }
        public static new SecurityRoleIndexGetArgs Empty => new SecurityRoleIndexGetArgs();
    }
}
